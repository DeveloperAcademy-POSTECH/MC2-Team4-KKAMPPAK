...
| Screen                                                                                                                         | Explanation                                                                                                                                                                                                                          |
|--------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="https://github.com/DeveloperAcademy-POSTECH/MC2-Team4-KKAMPPAK/assets/61380136/19a1a01f-e103-443b-9605-f321be257f2f" width="500"/> | <br/> 사용자는 하루에 최대 3개까지의 눈 스트레칭 알람을 설정할 수 있습니다. <br/> 사용자는 취침 시각과 같이 스마트폰 사용을 중단하고 눈 스트래칭을 진행할 시각을 설정하고 해당 시간에 스마트폰을 사용하고 있을 경우 푸시 알람을 받고 눈 스트레칭을 진행하도록 하여 지속적인 스마트폰 사용을 저지할 수 있습니다.  <br/>  <br/> |
