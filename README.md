...
| Screen                                                                                                                         | Explanation                                                                                                                                                                                                                          |
|--------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="" width="250"/> | <br/> Screen Time API를 이용하여 특정 앱을 사용할 때 설정한 핸드폰 사용 시간이 경과하면 알람을 울리게끔 해줍니다. <br/> 예를 들어, 사용자가 스마트폰에서 게임을 플레이하는 시간을 1시간 이하로 제한하려고 할 때, Screen TIme API는 해당 앱의 사용 시간을 추적하여 앱 사용 시간이 1시간을 초과할 시 알림을 전송합니다.  <br/>  <br/> |
